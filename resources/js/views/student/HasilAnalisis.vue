<template>
    ...
    <EmptyState
        ...
        :steps="['Upload CV kamu', 'Profil & CV dianalisis', 'Terima rekomendasi karier']"
    ...
    <div v-else class="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
                ...
                <div v-if="detectedSkills.length" class="flex flex-wrap gap-1.5">
                    <span
...
const gapSkills = computed(
    () =>
        bestMatch.value?.skill_gap_json ??
        analysis.value?.skill_gap_json ??
        [],
);
